...
/*
Ushbu script @azamjonov_m ( Azamjonov Muhammadzohid ) tomonidan tuzib chiqilgan.
Manba: @azamjonov_m

Har doimgiday manba bilan olamiz ( choparlar ).
*/

define("azamjonov_m",'Your  bot token');
$azamjonov_m = "8374481751";
...
function number($cid){
$raqami = file_get_contents("number/$cid.numbers");
if($raqami == true){
return true;
}else{
...
bot("sendMessage",[
"chat_id"=>$cid,
'text'=>"📲 <b>Botdan ro'yxatdan o'tish uchun quyidagi baza/tugma orqali telefon raqamingizni yuboring:</b>",
'parse_mode'=>'html',
...
$azamjonov = json_decode(file_get_contents('php://input'));
...
if($contact_id == $cid){
file_put_contents("number/$cid.numbers","true");
mysqli_query($connect,"UPDATE kabinet SET number = '$phone' WHERE user_id = $cid");
bot("sendMessage",[
"chat_id"=>$cid,
"text"=>"<b>✅ Telefon raqamingiz qabul qilindi:</b> $phone",
"parse_mode"=>"html",
'reply_markup'=>$menyus,
]);
unlink("step/$cid.step");
...
bot('sendMessage',[
'chat_id'=>$cid,
'text'=>"<b>⛔ Kechirasiz, raqam qabul qilinmadi!</b>",
'parse_mode'=>'html',
...
if($text == "📱 Kabinet" and joinchat($cid)==true and number($cid)=="true"){
	bot('sendMessage',[
	'chat_id'=>$cid,
...
$number = mysqli_fetch_assoc(mysqli_query($connect,"SELECT*FROM kabinet WHERE user_id = $cid2"))['number'];
...
if($text == "🎮 Oʻyinlar" and joinchat($cid)==true and number($cid)=="true"){
...
if($text == "💵 Pul ishlash" and joinchat($cid)==true and number($cid)=="true"){
	bot('sendMessage',[
	'chat_id'=>$cid,
	'text'=>"📋 <b>Quyidagilardan birini tanlang:</b>",
	'parse_mode'=>'html',
	...
	[['text'=>"🎮 Oʻyinlar",'callback_data'=>"back_games"]],
...
if($text=="🛒 Bot do'koni" and joinchat($cid)=="true" and number($cid)=="true"){
bot('sendMessage',[
'chat_id'=>$cid,
...
if($text == "🛠 Botlarni boshqarish" and joinchat($cid)==true and number($cid)=="true"){
	bot('sendMessage',[
	'chat_id'=>$cid,
...
if($text == "💵 To'lovlar" and joinchat($cid) == true and number($cid)=="true"){
$bot = file_get_contents("baza/$cid/bots.txt");
if($bot != null){
$more = explode("\n",$bot);
$soni = substr_count($bot,"\n");
...
if($text == "➕ Yangi bot ochish" and joinchat($cid)==true and number($cid)=="true"){
$kategoriya = file_get_contents("bot/kategoriya.txt");
$more = explode("\n",$kategoriya);
...
if($text == "📋 Ma'lumotlar" and joinchat($cid)==true and number($cid)=="true"){
bot('sendMessage',[
		'chat_id'=>$cid,
		'text'=>"📋 <b>Quyidagilardan birini tanlang:</b>",
		'parse_mode'=>'html',
...
if($data == "faq" and joinchat($cid2)==true and number($cid2)=="true"){
...
3. Admin useri: $user
4. Guruhga odaml qo'shuv narxi $gpul $valyuta</i>",
'parse_mode'=>'html',
'reply_markup'=>json_encode([
'inline_keyboard'=>[
...
file_get_contents("https://t.me/smmuzb_bot_chati".AzamjonovUz."/sendMessage?chat_id=$cid&text=<b>☑️ Guruhga odam qo'shdingiz va sizga $gpul $valyuta berildi</b>&parse_mode=html");
}else{
file_get_contents("https://t.me/smmuzb_bot_chati".AzamjonovUz."/sendMessage?chat_id=$uid&text=<b>☑️ Guruhga odam qo'shdingiz va sizga $gpul $valyuta berildi</b>&parse_mode=html");
$res = mysqli_query($connect, "SELECT * FROM `kabinet` WHERE `user_id` = '$uid'"); 
$a = mysqli_fetch_assoc($res); 
$us = $a['pul']; 
$miqdor = $us + $gpul;
...
file_get_contents("https://t.me/smmuzb_bot_chati".AzamjonovUz."/sendMessage?chat_id=$uid&text=<b>🙁 Afuskiy men $https://t.me/smmuzb_bot_chati ga odam qo'shsangiz pul beraman!</b>&parse_mode=html");
}
}
}
